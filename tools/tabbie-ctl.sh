...
case "$cmd" in
  ...
  list)
    echo "angry happy done focus break pomodoro idle hello sweat sleepy coffee mochi-happy mochi-angry mochi-love big-smile status-alert  (or any raw animation name)"; exit 0 ;;
  status)
